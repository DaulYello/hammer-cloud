...
public class ALiSmsUtil {
    ...
    static final String accessKeyId = "LTAIDt6Irazd3etk";
    ...
    public static SendSmsResponse send(String phone,HashMap<String, String> codeMap) throws ClientException {
        ...
        mobile_code =  (int) ((Math.random() * 9 + 1) * 100000);
     	codeMap.put(phone + "code", String.valueOf(mobile_code));
     	codeMap.put(phone + "time", String.valueOf(new Date().getTime()));
    ...
    public static QuerySendDetailsResponse querySendDetails(String bizId) throws ClientException {
        ...
        //必填-号码
        request.setPhoneNumber("17385834035");
        //可选-流水号
    ...
    public static void sendSMS(String phone,HashMap<String, String> codeMap) throws ClientException, InterruptedException {
    	//发短信
        SendSmsResponse response = send(phone, codeMap);
    ...
    /*public static void main(String[] args) throws ClientException, InterruptedException {
    	HashMap<String, String> codeMap = new HashMap<String, String>();
    	 //发短信
        SendSmsResponse response = send("17385834035", codeMap);
        System.out.println("短信接口返回的数据----------------");
        System.out.println("Code=" + response.getCode());
        System.out.println("Message=" + response.getMessage());
        System.out.println("RequestId=" + response.getRequestId());
